...
적용한 OLE 객체 렌더링 수정. 빌드 결과가 `../vendor/rhwp_python-0.8.0-cp310-abi3-manylinux_2_38_x86_64.whl`.
...
```
빌드엔 Rust 툴체인 + 시스템 freetype/fontconfig(개발 심볼릭) 필요. 상세 환경 메모는 프로젝트 노트 참조.
